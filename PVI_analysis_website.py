...
def generate_revenue_mindmap_dot():
    ...
    dot.node('central', 'Company Revenue Structure', 
             shape='box', style='rounded,filled', fillcolor='#9370DB', fontcolor='white', fontsize='30', penwidth='2')

    # Main Branches
    dot.node('non_insurance_biz', 'Doanh thu kinh doanh phi bảo hiểm và các hoạt động khác', 
             shape='box', style='rounded,filled', fillcolor='#FF69B4', fontcolor='white', fontsize='22')
    dot.node('insurance_biz', 'Doanh thu từ hoạt động kinh doanh bảo hiểm', 
             shape='box', style='rounded,filled', fillcolor='#BA55D3', fontcolor='white', fontsize='22')
    dot.node('financial_activities', 'Doanh thu từ hoạt động tài chính', 
             shape='box', style='rounded,filled', fillcolor='#FFD700', fontcolor='black', fontsize='22')
    ...
    dot.node('other_income', 'Thu nhập khác', 
             shape='box', style='rounded,filled', fillcolor='#FFB6C1', fontcolor='black', fontsize='18')
    ...
    dot.node('social_ins_collection', 'Hoạt động thu hộ bảo hiểm xã hội', 
             shape='box', style='rounded,filled', fillcolor='#FFF0F5', fontcolor='black', fontsize='16')
    ...
    dot.node('original_premium', 'Phí bảo hiểm gốc', 
             shape='box', style='rounded,filled', fillcolor='#DDA0DD', fontcolor='black', fontsize='18')
    ...
    dot.node('largest_contribution', 'Đóng góp lớn nhất: 20.178 tỷ đồng', 
             shape='box', style='rounded,filled', fillcolor='#E6E6FA', fontcolor='black', fontsize='16')
    ...
    dot.node('bond_investment_profit', 'Lãi đầu tư trái phiếu', 
             shape='box', style='rounded,filled', fillcolor='#FFFACD', fontcolor='black', fontsize='18')
